      ...
      <div className="flex flex-col md:flex-row items-start gap-8 relative z-10">
        ...
        <div className="md:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-6">
          {benefits.map(({ title, hoverText }, index) => (
            <div 
              key={index} 
              className="rounded-xl p-6 bg-gradient-to-br from-secondary/30 via-secondary/10 to-primary/40 text-white shadow-glow transition-all duration-500 relative overflow-hidden group h-[120px] border border-secondary/20 cursor-pointer hover:scale-105 hover:rotate-1 animate-fade-in-up"
