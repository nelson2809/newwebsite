      ...
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
        ...
        <div className="w-full lg:w-1/2 lg:max-w-2xl">
          ...
          <h2 className="text-5xl font-bold text-white mb-6 leading-tight">
            Enabling Business Growth with <span className="bg-gradient-to-r from-secondary via-cyan-400 to-secondary bg-clip-text text-transparent">Cloud Computing</span>
          </h2>
          ...
          <p className="text-xl text-white/90 leading-relaxed pl-4 border-l-4 border-secondary/40">
            Leveraging cloud solutions fosters innovation, efficiency, and scalability. <span className="text-secondary font-medium">Codework</span> empowers enterprises to embrace digital transformation seamlessly. Contact us today to explore tailored cloud solutions.
          </p>
        </div>
