...
const Card = ({ card, additionalStyle, index }) => {
  ...
  return (
    <div
      ...
      className={`relative ${card.roundedCorner} overflow-hidden border border-white/10 shadow-2xl bg-cover bg-center transition-all duration-500 hover:scale-105 cursor-pointer group h-[240px] sm:h-[320px] md:h-[360px] w-full max-w-[520px] animate-float-up`}
      style={{
    ...
    >
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-secondary via-primary to-secondary opacity-0 group-hover:opacity-40 transition-opacity duration-300"></div>
      </div>
