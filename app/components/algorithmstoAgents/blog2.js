      ...
      <div className="max-w-screen-xl mx-auto px-4 flex gap-8">
        ...
        <div className="flex-1 max-w-4xl">
          ...
          <section id="where-it-began" className="scroll-mt-24">
            <h2 className="text-2xl font-bold text-white mb-6">What It Was Like Before</h2>
            <p className="text-white/80 leading-relaxed mb-10">
          ...
          <section id="deep-learning-revolution" className="scroll-mt-24">
            <h2 className="text-2xl font-bold text-white mb-6">The Deep Learning Era</h2>
            <p className="text-white/80 leading-relaxed mb-10">
          ...
          <section id="rise-of-llms" className="scroll-mt-24">
            <h2 className="text-2xl font-bold text-white mb-6">Big Language Models Become Popular</h2>
            <p className="text-white/80 leading-relaxed mb-10">
          ...
          <section id="language-models-to-agents" className="scroll-mt-24">
            <h2 className="text-2xl font-bold text-white mb-6">From LM to Agents</h2>
            ...
            <p className="text-white/80 leading-relaxed mb-4">Where AI agents are concerned, they can:</p>
          ...
          <section id="open-vs-closed" className="scroll-mt-24">
            <h2 className="text-2xl font-bold text-white mb-6">Open vs. Closed: Two Paradigms, A Story</h2>
            <p className="text-white/80 leading-relaxed mb-4">
            ...
            <p className="text-white/80 leading-relaxed mb-4">Each method has its advantages:</p>
          ...
          <section id="current-ai-ecosystem" className="scroll-mt-24">
            <h2 className="text-2xl font-bold text-white mb-6">The AI Ecosystem Now</h2>
            <p className="text-white/80 leading-relaxed mb-4">
          ...
          <section id="where-heading" className="scroll-mt-24">
            ...
            <p className="text-white/80 leading-relaxed mb-4">The AI tomorrow is full of bright and promising points:</p>
