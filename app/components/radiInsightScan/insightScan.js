      ...
      <div className="container mx-auto px-8 lg:px-16 py-12 relative z-10">
        ...
        <div className="mb-12">
          ...
          <h2 className="text-5xl font-bold text-white mb-6">
            Turn Medical Jargon into <span className="bg-gradient-to-r from-secondary via-cyan-400 to-secondary bg-clip-text text-transparent">Patient Understanding</span>
          </h2>
        ...
        <div className="mb-12">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="bg-primary/40 backdrop-blur-xl rounded-3xl p-6 border border-white/20 shadow-2xl">
              ...
              <div className="mt-3 p-3 bg-white/10 rounded text-white/90 text-sm">
        ...
        <div className="mb-12">
          ...
          <ul className="space-y-2 text-white/90 list-disc list-inside pl-3">
