            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
              {services.map((service, index) => (
                ...
                >
                  ...
                  <div className="absolute -bottom-8 sm:-bottom-10 md:-bottom-12 left-4 right-4 bg-primary/20 backdrop-blur-xl border border-white/10 rounded-2xl p-4 sm:p-5 md:p-6 shadow-2xl z-10 group-hover:bg-primary/30 group-hover:border-white/30 transition-all duration-500 group-hover:scale-105">
                    {/* Subtle inner glow */}
