...
const WhyJoinCodework = () => {
  ...
  return (
    <section className="relative w-full bg-secondary text-primary py-16 md:py-20 lg:py-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 md:mb-8 text-primary">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-primary/90 font-light max-w-3xl mx-auto">
            Discover what makes <span className="text-primary font-medium">Codework</span> the perfect place for your career growth
          </p>
        </div>
          ...
          {reasons.map((reason, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-4 sm:p-6 md:p-8">
                ...
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-primary mb-2 transform transition-all duration-500 group-hover:translate-y-0">
                  {reason.title}
                </h3>
                
                {/* Description - Shows on hover */}
                <p className="text-primary/90 text-sm sm:text-base md:text-lg leading-relaxed opacity-0 transform translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 delay-200">
                  {reason.description}
                </p>
        ...
        <div className="mt-16 md:mt-20 text-center">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 max-w-3xl mx-auto">
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 md:p-6 border border-white/10 hover:bg-white/10 hover:border-white/30 transition-all duration-300">
              ...
              <div className="text-primary/70 text-xs md:text-sm">Key Benefits</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 md:p-6 border border-white/10 hover:bg-white/10 hover:border-white/30 transition-all duration-300">
              <div className="text-2xl md:text-3xl font-bold text-primary mb-2">50+</div>
              <div className="text-primary/70 text-xs md:text-sm">Team Members</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 md:p-6 border border-white/10 hover:bg-white/10 hover:border-white/30 transition-all duration-300">
              <div className="text-2xl md:text-3xl font-bold text-primary mb-2">Remote</div>
              <div className="text-primary/70 text-xs md:text-sm">Work Options</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 md:p-6 border border-white/10 hover:bg-white/10 hover:border-white/30 transition-all duration-300">
              <div className="text-2xl md:text-3xl font-bold text-primary mb-2">Growth</div>
              <div className="text-primary/70 text-xs md:text-sm">Opportunities</div>
            </div>
          </div>
        </div>
      </div>
