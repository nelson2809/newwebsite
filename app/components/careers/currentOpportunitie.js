...
const CurrentOpportunities = () => {
  ...
  return (
    <section className="relative w-full min-h-screen py-8 sm:py-12 md:py-16 lg:py-20 xl:py-24 bg-secondary text-primary overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-8 sm:mb-10 md:mb-12 lg:mb-16">
          ...
          <div className="w-12 sm:w-16 md:w-20 lg:w-24 h-0.5 sm:h-1 bg-gradient-to-r from-primary to-transparent rounded-full mx-auto mb-4 sm:mb-6 md:mb-8"></div>
          
          <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-primary/90 font-light max-w-3xl mx-auto px-2">
            Join our team and be part of something <span className="text-primary font-medium">extraordinary</span>
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-5 md:gap-6 lg:gap-8">
          {jobOpenings.map((job, index) => (
            ...
            >
              ...
              <h3 className="text-lg sm:text-xl md:text-xl lg:text-2xl font-bold text-primary mb-3 sm:mb-4 md:mb-6 transition-colors duration-300 leading-tight pr-8">
                {job.title}
              </h3>
              ...
              <div className="space-y-2 sm:space-y-3 md:space-y-4 mb-4 sm:mb-6 md:mb-8">
                <div className="flex items-center text-primary/80">
                  <div className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-primary/20 rounded-full flex items-center justify-center mr-2 sm:mr-3 flex-shrink-0">
                    <FaCalendarAlt className="text-primary text-xs sm:text-sm" />
                  </div>
                ...
                <div className="flex items-center text-primary/80">
                  <div className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-primary/20 rounded-full flex items-center justify-center mr-2 sm:mr-3 flex-shrink-0">
                    <FaBriefcase className="text-primary text-xs sm:text-sm" />
                  </div>
              ...
              <Link href="/join-our-team">
                <button className="inline-flex w-full justify-center items-center px-3 py-1.5 sm:px-4 sm:py-2 border-2 border-primary text-primary rounded-lg hover:bg-primary hover:text-secondary backdrop-blur-sm transition-all duration-300 text-xs sm:text-sm font-medium group/btn">
                  <span>Apply Now</span>
        ...
        <div className="mt-12 sm:mt-16 md:mt-20 lg:mt-24">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6 lg:gap-8 max-w-4xl mx-auto">
            <div className="bg-white/5 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-6 border border-white/10 text-center hover:bg-white/10 hover:border-white/30 transition-all duration-300">
              <div className="text-xl sm:text-2xl md:text-3xl font-bold text-primary mb-1 sm:mb-2">{jobOpenings.length}</div>
              <div className="text-primary/70 text-xs sm:text-sm">Open Positions</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-6 border border-white/10 text-center hover:bg-white/10 hover:border-white/30 transition-all duration-300">
              <div className="text-xl sm:text-2xl md:text-3xl font-bold text-primary mb-1 sm:mb-2">Fast</div>
              <div className="text-primary/70 text-xs sm:text-sm">Hiring Process</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-6 border border-white/10 text-center hover:bg-white/10 hover:border-white/30 transition-all duration-300">
              <div className="text-xl sm:text-2xl md:text-3xl font-bold text-primary mb-1 sm:mb-2">Remote</div>
              <div className="text-primary/70 text-xs sm:text-sm">Work Options</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-6 border border-white/10 text-center hover:bg-white/10 hover:border-white/30 transition-all duration-300 col-span-2 md:col-span-1">
              <div className="text-xl sm:text-2xl md:text-3xl font-bold text-primary mb-1 sm:mb-2">Growth</div>
              <div className="text-primary/70 text-xs sm:text-sm">Opportunities</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-0 right-0 opacity-20">
        <div className="w-16 h-8 sm:w-32 sm:h-16 md:w-64 md:h-32 bg-gradient-to-l from-primary/30 to-transparent rounded-tl-full"></div>
      </div>
    </section>
  );
};
