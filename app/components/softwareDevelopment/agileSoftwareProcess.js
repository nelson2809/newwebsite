...
const steps = [
  ...
  },
  {
    ...
    description: 'It involves contemporary frameworks for iterative processes, enabling swift and efficient deployment.',
    Icon: FaBolt,
    step: '03'
  },
  {
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 sm:mb-6 px-2">
            Agile <span className="bg-gradient-to-r from-secondary via-cyan-400 to-secondary bg-clip-text text-transparent">Software Development</span> Process
          </h2>
