...
import { FaSearch, FaDraftingCompass, FaPaintBrush, FaMobileAlt, FaTachometerAlt, FaRocket } from 'react-icons/fa';
...
const steps = [
  ...
  },
  {
    ...
    description: 'Designing layout structures and creating interactive prototypes.',
    Icon: FaDraftingCompass,
    step: '02',
  },
  {
    title: 'Creative UI/UX Implementation',
    description: 'Crafting functional and visually engaging user interfaces.',
    Icon: FaPaintBrush,
    step: '03',
  },
  {
    title: 'Responsive Development',
    description: 'Ensuring seamless usability across all devices and screen sizes.',
    Icon: FaMobileAlt,
    step: '04',
  },
  {
    title: 'Performance Optimization',
    description: 'Improving speed, security, and overall functionality.',
    Icon: FaTachometerAlt,
    step: '05',
  },
  {
    title: 'Launch & Ongoing Support',
    description: 'Providing continuous maintenance, updates, and support post-launch.',
    Icon: FaRocket,
    step: '06',
  },
];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 sm:mb-6 px-2">
            Strategic <span className="bg-gradient-to-r from-secondary via-cyan-400 to-secondary bg-clip-text text-transparent">Web Design</span> Process
          </h2>
          ...
          <p className="text-white/90 max-w-3xl mx-auto text-sm sm:text-base lg:text-lg leading-relaxed px-4">
            Delivering engaging websites through thoughtful designs, responsive development, and continuous support.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 sm:gap-10 lg:gap-12 items-start">
          ...
          {/* Right Section: Web Design Process Cycle */}
