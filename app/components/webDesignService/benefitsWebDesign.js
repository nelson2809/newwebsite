...
const BenefitsWebDesign = () => {
  const benefits = [
    ...
    },
    {
      ...
      hoverText: "Ensuring seamless functionality and accessibility across all devices and screen sizes."
    },
    {
      title: "User-Centered Interface",
      hoverText: "Intuitive navigation and engaging elements to improve conversions and user satisfaction."
    },
    {
