      ...
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
        ...
        <div className="w-full lg:w-1/2 lg:max-w-2xl">
          ...
          <h2 className="text-5xl font-bold text-white mb-6 leading-tight">
            Transform Business with <span className="bg-gradient-to-r from-secondary via-cyan-400 to-secondary bg-clip-text text-transparent">Custom Software</span>
          </h2>
          ...
          <p className="text-xl text-white/90 leading-relaxed pl-4 border-l-4 border-secondary/40">
            Explore tailored software solutions with <span className="text-secondary font-medium">Codework</span> to drive efficiency and growth. Contact us today for a consultation.
          </p>
        </div>
