      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="border border-primary/10 p-8 rounded-none hover:border-primary/30 transition-colors group">
            ...
            <button className="flex items-center text-primary hover:text-secondary transition-colors mt-8 border border-primary px-4 py-2 rounded-none hover:bg-primary">
          ...
          <div className="border border-primary/10 p-8  rounded-none hover:border-primary/30 transition-colors group">
            ...
            <a href="https://cplc.codework.ai/" target="_blank" rel="noopener noreferrer" className="flex items-center text-primary hover:text-secondary transition-colors mt-8 border border-primary px-4 py-2 rounded-none hover:bg-primary">
          ...
          <div className="border border-primary/10 p-8 rounded-none hover:border-primary/30 transition-colors group">
            ...
            <Link href="/schedule-a-demo" className="flex items-center text-primary hover:text-secondary transition-colors mt-8 border border-primary px-4 py-2 rounded-none hover:bg-primary">
          ...
          <div className="border border-primary/10 p-8 rounded-none hover:border-primary/30 transition-colors group">
            ...
            <Link href="/other-inquiries" className="flex items-center text-primary hover:text-secondary transition-colors mt-8 border border-primary px-4 py-2 rounded-none hover:bg-primary">
