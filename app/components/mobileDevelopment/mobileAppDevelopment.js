...
import { 
  FaMobile,      // ✅ For Native App Development
  FaCode,        // ✅ For Cross-Platform App Development
  FaBuilding,    // ✅ For Enterprise Mobile Applications
  FaBrain,       // ✅ For AI-Powered Mobile Apps
  FaPalette,     // ✅ For Mobile UI/UX Design
  FaGlobe,       // ✅ For Progressive Web Apps (PWAs)
  FaTools        // ✅ For App Maintenance & Optimization
} from 'react-icons/fa';
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-5xl font-bold text-white mb-6">
            Comprehensive <span className="bg-gradient-to-r from-secondary via-cyan-400 to-secondary bg-clip-text text-transparent">Mobile Development</span> Solutions
          </h2>
