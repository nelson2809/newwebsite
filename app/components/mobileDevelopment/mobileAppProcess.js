...
import { FaClipboardList, FaPalette, FaBolt, FaCheckCircle, FaUpload, FaTools } from 'react-icons/fa';
import MobileAppProcessCycle from './mobileAppProcessCycle';
const steps = [
  {
    title: 'Strategy and Planning',
    description: 'Define business objectives and determine the app\'s technical framework.',
    Icon: FaClipboardList,
    step: '01',
  },
  {
    title: 'UI/UX Design',
    description: 'Create visually appealing and user-friendly app interfaces.',
    Icon: FaPalette,
    step: '02',
  },
  {
    title: 'Agile Development',
    description: 'Develop secure, reliable, and high-performing applications.',
    Icon: FaBolt,
    step: '03',
  },
  {
    title: 'Testing and Quality Assurance',
    description: 'Ensure seamless functionality across all devices.',
    Icon: FaCheckCircle,
    step: '04',
  },
  {
    title: 'Deployment & Launch',
    description: 'Releasing apps on platforms like Google Play and the App Store to make them accessible to users.',
    Icon: FaUpload,
    step: '05',
  },
  {
    title: 'Continuous Support',
    description: 'Check how the app works, fix any problems, and add new features to improve it for users.',
    Icon: FaTools,
    step: '06',
  },
];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 sm:mb-6 px-2">
            Streamlined <span className="bg-gradient-to-r from-secondary via-cyan-400 to-secondary bg-clip-text text-transparent">Mobile App Development</span> Process
          </h2>
          ...
          <p className="text-white/90 max-w-3xl mx-auto text-sm sm:text-base lg:text-lg leading-relaxed px-4">
            Our client-centered and agile approach ensures successful, efficient delivery of impactful mobile applications.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 sm:gap-10 lg:gap-12 items-start">
          ...
          {/* Right Section: Mobile App Process Cycle */}
