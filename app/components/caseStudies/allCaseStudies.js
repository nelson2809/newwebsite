...
const AllCaseStudies = () => {
  ...
  return (
    <div className="bg-secondary text-primary mx-auto px-4 sm:px-6 md:px-24 py-12 sm:py-24 relative overflow-hidden">
     

      {/* Enhanced Header */}
      <div className="text-center mb-16 relative z-10">
     
        <h2 className="text-4xl font-bold mb-6 animate-slide-up text-primary">
        ...
        <div className="relative animate-slide-up animation-delay-200">
          ...
          <p className="text-primary/90 text-lg max-w-3xl mx-auto">
            Discover how we've transformed challenges into <span className="text-primary font-medium">innovative solutions</span>
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 relative z-10">
        {visibleStudies.map(({ id, title, description, imageUrl, link }, index) => (
          <div
            key={id}
            className="group bg-secondary/30 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden hover:bg-secondary/40 hover:border-white/30 transition-all duration-500 transform hover:-translate-y-2 hover:shadow-2xl animate-card-float"
          ...
          >
            ...
            <div className="p-6 sm:p-8">
              <h3 className="text-xl sm:text-2xl text-primary font-bold mb-3 transition-colors duration-300">
                {title}
              </h3>
              ...
              <a
                href={link}
                className="inline-flex items-center text-primary hover:text-primary text-sm font-semibold border border-white/20 hover:border-white/40 hover:bg-white/10 px-4 py-2 rounded-lg transition-all duration-300 backdrop-blur-sm group/btn"
              >
                <span>Read More</span>
                <svg 
