    ...
    <div className="min-h-screen bg-secondary text-primary">
      ...
      <div className="max-w-4xl mx-auto px-4 pb-20">
        <div className="text-center space-y-8 transition-all duration-500">
          ...
          <div className="pt-6">
            <button className="group inline-flex items-center gap-3 text-lg font-semibold hover:gap-5 transition-all duration-300 border border-primary px-5 py-3 rounded-none hover:bg-primary hover:text-secondary">
