...
import { 
  FaLock,        // ✅ Definitely exists - for security/network
  FaGlobe,       // ✅ Definitely exists - for web applications
  FaCloud,       // ✅ Definitely exists - for cloud
  FaMobile,      // ✅ Definitely exists - for mobile (not FaMobileAlt)
  FaWifi,        // ✅ Definitely exists - for wireless
  FaUser,        // ✅ Definitely exists - for social engineering
  FaEye          // ✅ Definitely exists - for red team/monitoring
} from 'react-icons/fa';
  ...
  const cards = [
    {
      ...
      Icon: FaLock,     // ✅ Using FaLock instead of FaShield
    ...
    },
    {
      ...
      Icon: FaMobile,   // ✅ Using FaMobile instead of FaMobileAlt
      gradient: "from-secondary/80 to-secondary/60",
    },
    {
    ...
    },
    {
      ...
      Icon: FaUser,     // ✅ Using FaUser instead of FaUserSecret
    ...
    },
    {
      ...
      Icon: FaEye,      // ✅ Using FaEye instead of FaUserNinja
