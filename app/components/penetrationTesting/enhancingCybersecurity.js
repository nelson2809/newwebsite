      ...
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
        ...
        <div className="w-full lg:w-1/2 lg:max-w-2xl">
          ...
          <h2 className="text-5xl font-bold text-white mb-6 leading-tight">
            Cybersecurity Resilience with <span className="bg-gradient-to-r from-secondary via-cyan-400 to-secondary bg-clip-text text-transparent">Codework</span>
          </h2>
          ...
          <p className="text-xl text-white/90 leading-relaxed pl-4 border-l-4 border-secondary/40">
            As cyber threats grow more sophisticated, adopting proactive security strategies is vital. <span className="text-secondary font-medium">Codework</span> specializes in identifying security vulnerabilities, minimizing cyber risks, and fortifying digital infrastructure to ensure long-term protection. Schedule a penetration testing assessment today to enhance cybersecurity resilience and prevent potential cyberattacks.
          </p>
        </div>
