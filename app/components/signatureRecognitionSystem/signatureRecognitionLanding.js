        ...
        <div className="md:w-5/12 bg-gradient-to-br from-primary/40 via-primary/60 to-primary/80 backdrop-blur-xl border border-white/20 p-8 pb-6 rounded-3xl text-white z-20 -mr-28 md:-mr-32 self-end shadow-2xl shadow-secondary/25 hover:scale-105 transition-all duration-500 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-base md:text-lg w-[90%] leading-relaxed text-white/90 pl-6 font-light">
              The <span className="text-secondary font-medium">Handwritten Signature Recognition System</span> is an innovative solution tailored for verifying handwritten signatures through sophisticated techniques like <span className="text-secondary font-medium">template matching</span> and <span className="text-secondary font-medium">correlation</span>. Employing advanced <span className="text-secondary font-medium">image processing methods</span>, this system ensures accurate authentication by comparing input signatures with a comprehensive database of existing samples.
            </p>
          </div>
