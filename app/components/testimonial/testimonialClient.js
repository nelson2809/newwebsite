...
const TestimonialClient = () => {
  return (
    <div className="bg-secondary text-primary relative overflow-hidden px-6 md:py-20  space-y-20">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-32 left-16 w-3 h-3 bg-primary rounded-full"></div>
        <div className="absolute top-48 right-20 w-2 h-2 bg-white/60 rounded-full"></div>
        <div className="absolute bottom-56 left-1/4 w-4 h-4 bg-primary/80 rounded-full"></div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-16 max-w-7xl mx-auto relative z-10">
        ...
        <div className="relative flex items-center justify-center group">
          {/* Outer Glow Ring */}
          <div className="absolute inset-0 bg-gradient-to-r from-primary/20 to-primary/30 rounded-full blur-2xl scale-125 opacity-60 group-hover:scale-130 transition-all duration-700"></div>
          
          {/* Rotating Border Ring */}
          <div className="absolute inset-0 w-80 h-80 rounded-full border-2 border-primary/30 animate-spin" style={{animationDuration: '20s'}}></div>
          <div className="absolute inset-4 w-72 h-72 rounded-full border border-primary/20 animate-spin" style={{animationDuration: '15s', animationDirection: 'reverse'}}></div>
          
          {/* Main Image Frame */}
          <div className="relative w-72 h-72 rounded-full bg-gradient-to-br from-primary/40 via-primary/60 to-primary/80 p-1 shadow-2xl shadow-primary/20 group-hover:scale-105 transition-all duration-500">
            <div className="w-full h-full rounded-full bg-white/5 backdrop-blur-xl border border-white/20 p-8 flex items-center justify-center relative overflow-hidden">
              ...
              <div className="absolute bottom-8 left-6 w-1 h-1 bg-primary/60 rounded-full animate-bounce"></div>
              <div className="absolute top-1/2 right-4 w-1.5 h-1.5 bg-primary/80 rounded-full animate-ping"></div>
              
              {/* Gradient Overlay */}
              <div className="absolute inset-0 bg-gradient-to-tr from-primary/30 via-transparent to-primary/20 rounded-full pointer-events-none"></div>
            </div>
          </div>
        ...
        <div className="bg-primary/30 backdrop-blur-xl border border-white/10 text-primary p-8 rounded-3xl shadow-2xl max-w-2xl hover:bg-primary/40 hover:border-white/30 transition-all duration-500 relative">
          {/* Quote Icon */}
          ...
          <div className="flex items-center space-x-4">
            <div className="w-12 h-12 bg-gradient-to-r from-primary to-primary/80 rounded-full flex items-center justify-center text-secondary font-bold text-lg">
              J
            </div>
            <div>
      ...
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-16 max-w-7xl mx-auto relative z-10">
        ...
        <div className="relative flex items-center justify-center group">
          ...
          <div className="relative w-80 h-80 flex items-center justify-center">
            {/* Hexagon Shape */}
            <div 
              className="absolute inset-0 bg-gradient-to-br from-primary/30 to-primary/50 transform rotate-12 group-hover:rotate-0 transition-all duration-700"
              style={{
            ...
            {/* Image Container */}
            <div className="relative w-56 h-56 bg-primary/40 backdrop-blur-sm rounded-3xl flex items-center justify-center shadow-2xl shadow-primary/20 group-hover:scale-105 transition-all duration-500 border border-white/10">
              <img
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-16 max-w-7xl mx-auto relative z-10">
        ...
        <div className="relative flex items-center justify-center group">
          ...
          {/* Modern Card Frame */}
          <div className="relative w-80 h-96 bg-gradient-to-br from-white/10 via-white/5 to-primary/30 backdrop-blur-xl rounded-3xl p-6 shadow-2xl shadow-primary/25 border border-white/20 group-hover:scale-105 transition-all duration-500">
            
            {/* Top Accent Bar */}
            <div className="w-full h-2 bg-gradient-to-r from-primary via-primary/60 to-transparent rounded-full mb-6"></div>
            ...
            <div className="relative w-full h-64 bg-primary/20 rounded-2xl flex items-center justify-center overflow-hidden border border-white/10">
              ...
              <div className="absolute inset-0 bg-gradient-to-tr from-primary/40 via-transparent to-primary/20"></div>
              
              {/* Floating Geometric Shapes */}
              <div className="absolute top-4 right-4 w-3 h-3 bg-primary/60 rounded-full animate-ping"></div>
              <div className="absolute bottom-6 left-6 w-2 h-2 bg-primary/40 rounded-full animate-pulse"></div>
            </div>
          ...
          <div className="absolute -left-4 top-1/2 transform -translate-y-1/2 w-12 h-24 bg-gradient-to-r from-primary/20 to-transparent rounded-r-full"></div>
          <div className="absolute -right-4 top-1/3 w-8 h-16 bg-gradient-to-l from-primary/15 to-transparent rounded-l-full"></div>
        </div>
