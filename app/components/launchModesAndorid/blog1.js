      ...
      <div className="max-w-screen-xl mx-auto px-4 flex gap-8">
        ...
        <div className="flex-1 max-w-4xl">
          ...
          <section id="standard-mode" className="scroll-mt-24">
            <h2 className="text-2xl font-bold text-white mb-4">Standard Launch Mode</h2>
          ...
          <section id="singletask-mode" className="scroll-mt-24">
            <h2 className="text-2xl font-bold text-white mb-4">SingleTask Launch Mode</h2>
            <div className="bg-primary/80 rounded-lg p-6 mb-10 border border-secondary/40 shadow-glow">
              <p className="text-white/90 mb-3">
          ...
          <section id="singleinstance-mode" className="scroll-mt-24">
            <h2 className="text-2xl font-bold text-white mb-4">SingleInstance Launch Mode</h2>
            <div className="bg-primary/80 rounded-lg p-6 mb-10 border border-secondary/40 shadow-glow">
              <p className="text-white/90 mb-3">
                ...
                <table className="w-full text-white text-sm">
                  <thead>
                    <tr className="border-b border-secondary/40">
                      <th className="text-left py-2 text-secondary">Launch Mode</th>
                      <th className="text-left py-2 text-secondary">Instance Creation</th>
                      <th className="text-left py-2 text-secondary">Use Case</th>
                    </tr>
                  </thead>
                  <tbody>
